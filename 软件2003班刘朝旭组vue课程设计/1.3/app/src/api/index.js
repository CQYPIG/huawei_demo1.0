...
//获取首页category数据的接口
export const reqCategoryList = () => mockRequests({ url: '/getCategoryList', method: 'get'});
//获取首页lunbo  banner数据的接口
export const reqBannerList = () => mockRequests({ url: '/getBannerList', method: 'get'});



// //获取search数据接口
export const reqGetSearchList = (params)=>mockRequests({url:'/getSearchList',method:'post',data:params});
// //获取search数据接口
export const reqGetSpxq = ()=>mockRequests({url:'/getSpxq',method:'get'});
// //获取search数据接口
export const reqGetOrder = ()=>mockRequests({url:'/getOrder',method:'get'});
