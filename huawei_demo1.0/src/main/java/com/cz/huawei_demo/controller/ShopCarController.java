...
public class ShopCarController {
    ...
    @GetMapping("/changeCommodityNumberOfRedis/{commodityNumber}/{shopCarId}/{userId}")
    public Result changeCommodityNumberOfRedis(@PathVariable("commodityNumber") String commodityNumber,
                                        @PathVariable("shopCarId") String shopCarId,
                                               @PathVariable("userId")String userId){
        return shopCarService.changeCommodityNumberOfRedis(commodityNumber,shopCarId,userId);
    }
